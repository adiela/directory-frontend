...
const SocialLink = ({location, children}) => {
    return (
        <Link href={location}>
...
const FooterLink = ({location, children}) => {
    return (
...
const Footer = () => {
    return (
        <footer className="bg-turquoise text-white text-sm mt-12">
            <div className="flex-container pt-5">
                <div className="my-5 grid grid-cols-2">
                    <div className="text-lg">
                        ...
                        <SocialLink location="/">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="fill-current inline">
                                <path
                    ...
                    <ul className="text-right flex flex-wrap content-end justify-end">
                        <FooterLink location="/">Privacy Policy</FooterLink>
                        <FooterLink location="/">Terms</FooterLink>
                        <FooterLink location="/">FAQ</FooterLink>
                        <FooterLink location="/">Contact</FooterLink>
                    </ul>
                </div>
                <hr/>
                <div className="p-5 text-center"> © Brand name {(new Date().getFullYear())}</div>
            </div>
        </footer>
    );
};
